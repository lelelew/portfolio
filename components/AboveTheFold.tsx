    ...
    <div className={classes.root}>
      ...
      <div className={classes.right}>
        ...
        <p className={classes.description}>
          I'm a self-taught web developer with a background in startups and financial auditing.  I like to research, understand, and build. My passion for development comes from seeing things <strong>work</strong>.
        </p>
        <div className={classes.buttons}>
          <a href="mailto:lele@lelelew.com">Contact</a>
          <a href="https://github.com/lelelew">Github</a>
          <a href="/Lele%20Lew%20-%20Resume%20-%20November%202020.pdf">Resume</a>
        </div>
